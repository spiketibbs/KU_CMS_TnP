...
eta_keys = ["Eta_1", "Eta_2", "Eta_3", "Eta_4"]
eta_labels_map = {
    "Eta_1": "|η| ≤ 0.9",
    "Eta_2": "0.9 < |η| ≤ 1.2",
    "Eta_3": "1.2 < |η| ≤ 2.1",
...
selections = [
'GoldID_2022_preEE', 'GoldID_2022_postEE', 'ISO_2022_preEE'   , 'ISO_2022_postEE', 'PROMPT_2022_preEE', 'PROMPT_2022_postEE', 
'blp_2022_preEE'   , 'blp_2022_postEE', 'Not_Prompt_2022_preEE', 'Not_Prompt_2022_postEE', 'ID_nor_ISO_2022_preEE', 'ID_nor_ISO_2022_postEE',
]
...
for set_name, dataset in all_datasets.items():
    ...
    for sel_idx, sel_name in enumerate(selections):
        ...
        plot_heatmap(
            ...
            output_file=f"Fitter/AN_HEATMAPS_MUONS_1/2022/{set_name}/{set_name}_{sel_name}_HEATMAP.pdf"
        )