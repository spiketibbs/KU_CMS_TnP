...
Determining Efficiencies and Scale Factors for electrons and muons in Eras 2 and 3 in the Compact Muon Solenoid (CMS) detector within the Large Hadron Collider (LHC).  
...
8. With your new environment activated, you will install the egamma tnp as well as a few additional packages:
```
pip install -e .
...
data_dict = {
    ...
    '2023 postBPix': [(0.9321, 0.0024), (0.9432, 0.0029), (0.9545, 0.0027)],
    '2023 preBPix':  [(0.9267, 0.0034), (0.9358, 0.0031), (0.9569, 0.0026)],
